...
# Update these values with the ngrok URL
# ngrok_url = "http://<subdomain>.ngrok.io"  # Replace <subdomain> with your actual ngrok subdomain
ngrok_url = "http://tender-eagerly-anchovy.ngrok-free.app"
...
def send_post_req():
    ...
    try:
        ...
        r = requests.post(f"{ngrok_url}", data=payload, headers={"Content-Type": "application/json"})
